    ...
    public static function faqReply(string $message): string
    {
        ...
        $faq = [
            ...
            [['circle', 'invite', 'member', 'five', '5 people', 'household'],
                'A circle is up to five people in one household. Invite them from Check (home) with just an email, or from Circle. Circle status is Invited → Invite sent → Invite Accepted → User Accesses the Circle. Anyone in the circle can look at a check. Tap “Please call me before I pay” or “Send to family circle” to email (and optionally text) the rest of the circle. ' . Analyze::CORE_RULE],
