...
Family plan: up to **five people**. **$14.99/month** or **$119.99/year**. Stripe Checkout is wired — paste keys per **[STRIPE.md](STRIPE.md)**. Password reset and 2FA: **[AUTH.md](AUTH.md)**.
...
**https://raw.githubusercontent.com/devildog5x5/InPmnt/cursor/ourcircle-family-shield-4df6/patches/FamilyShieldPro-1.1.0.zip**
