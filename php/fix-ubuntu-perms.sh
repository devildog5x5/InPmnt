...
#
# Verified on Ubuntu 24.04 / Apache 2.4.58:
#   files 644 + dirs 755  → www-data can READ (homepage)
#   data/ 775 www-data    → www-data can WRITE SQLite (signup)
#   document root 700     → 403 "unable to read htaccess file"
#   777 on PHP files      → not required
set -euo pipefail
