...
<head>
  ...
  <meta name="description" content="Choose a new InPmnt password and return to your invoices and client payment reminders." />
...
<body>
  <div class="auth-page">
    <div class="auth-card">
      ...
      <p class="lead">Pick a password at least 8 characters long.</p>
      <?php if (!empty($error)): ?>
