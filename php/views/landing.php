...
<head>
  ...
  <title>InPmnt â€” Get paid without the chase</title>
...
<body class="landing">
  <nav class="landing-nav">
    <div class="brand">
      ...
      <div class="brand-copy">
        ...
        <div class="brand-sub" style="color:var(--muted)">Invoice chase Â· Payment reminders</div>
      </div>
    </div>
  ...
  <section class="landing-section" id="features">
    ...
    <p class="sub">A focused tool â€” not another bloated accounting suite.</p>
    <div class="feature-grid">
      <article class="feature">
        <h3>Smart reminder schedules</h3>
        <p>Auto-queue friendly nudges before due date, on the day, and after â€” email or SMS templates you control.</p>
      </article>
      <article class="feature">
        <h3>Aging &amp; overdue dashboard</h3>
        <p>See open balances, 1â€“30 / 31â€“60 / 60+ aging, and which invoices need a final notice today.</p>
      </article>
      <article class="feature">
        <h3>One-tap final notice</h3>
        <p>Escalate politely when someoneâ€™s been quiet too long. Log every send for your records.</p>
      </article>
      <article class="feature">
        <h3>Clients &amp; open balances</h3>
        <p>Keep contact details, notes, and who still owes you â€” without leaving the app.</p>
      </article>
      <article class="feature">
        <h3>Payment tracking</h3>
        <p>Record partial or full payments and watch reminders cancel themselves when youâ€™re paid.</p>
      </article>
      <article class="feature">
  ...
  <section class="landing-section" id="pricing">
    ...
    <p class="sub" style="margin-top:18px">
      ...
      Stripe Checkout is live â€” cards processed securely by Stripe.
      <?php else: ?>
      Stripe keys not configured yet â€” buttons open the demo workspace. Add keys from <code>.env.example</code> to go live.
      <?php endif; ?>
