...
|---------|----------------|----------|
| **PHP (Hostinger)** | Unzip into `public_html` — no VPS | [InPmnt-PHP.v1.5.03.zip](https://github.com/devildog5x5/InPmnt/releases/download/v1.5.03/InPmnt-PHP.v1.5.03.zip) |
| **Portable** | Runnable Windows app — `install.ps1` or `start.ps1` | [InPmnt-Portable.v1.5.03.zip](https://github.com/devildog5x5/InPmnt/releases/download/v1.5.03/InPmnt-Portable.v1.5.03.zip) |
| **Source** | Full source (Python + PHP + Docker) | [InPmnt-Source.v1.5.03.zip](https://github.com/devildog5x5/InPmnt/releases/download/v1.5.03/InPmnt-Source.v1.5.03.zip) |
| **Icon** | Brand icon assets (blue / teal / violet) | [InPmnt-Icon.v1.5.03.zip](https://github.com/devildog5x5/InPmnt/releases/download/v1.5.03/InPmnt-Icon.v1.5.03.zip) |

- Latest release: [v1.5.03](https://github.com/devildog5x5/InPmnt/releases/tag/v1.5.03)
...
- Rebuild locally: `powershell -File .\build_release.ps1` or `python3 build_release.py` → `installers\*.zip`. Pushing a `vX.Y.Z` tag publishes those zips on GitHub Releases.
...
1. Download [InPmnt-PHP.v1.5.03.zip](https://github.com/devildog5x5/InPmnt/releases/download/v1.5.03/InPmnt-PHP.v1.5.03.zip).
